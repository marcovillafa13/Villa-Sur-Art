...
export default function Contact() {
  ...
  const subjects = ['Consulta sobre una obra', 'Encargo personalizado', 'Visita al taller', 'Otro']
      ...
      <div className={styles.container}>
        <div className={styles.textCol}>
          ...
          <p className={styles.desc}>
            Completá el formulario y te contactaremos por WhatsApp. También podés escribirnos
            directamente si preferís una respuesta más rápida.
          </p>
          <a
